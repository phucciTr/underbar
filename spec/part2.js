  ...
  describe('Part II', function() {
    ...
    describe('contains', function() {
      ...
      it('should return false given an array and a value not in that array', function() {
        ...
        expect(_.contains([2, 3, 4], 6)).to.be.true; //     (Test passes)
        // expect(_.contains([2, 3, 4], 6)).to.be.false; // (Test fails)
      });
    ...
    describe('extend', function() {
      ...
      it('should override properties found on the destination', function() {
        ...
        // the behavior described by the `it` string
        // throw new Error('This test is missing.');
        var destination = { property: 1 };
        var source = { property: 2 };
        var extended = _.extend(destination, source);

        expect(destination.property).to.equal(2);
      });
